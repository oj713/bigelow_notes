...
the new dataset, `dataCar` contains information on insurance policies for cars. the outcome `clm` represents whether a claim was taken out.
...
# fit logistic model of claim as a function of veh_value
log_mod <- gam(clm ~ s(veh_value), data = dataCa, family = binomial, method = "REML")
